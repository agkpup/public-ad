...
<div class="float-center ml-4 mr-4 p-3">
    <center class="bg-danger text-white p-3"> <h4>Something Error Occurred !</h4> </center>
    <center class="bg-dark text-white p-3"> <h4> Return to <a href="/">Home Page</a> </h4> </center>
</div>
  </div>
</template>
